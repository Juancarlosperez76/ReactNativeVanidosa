...
const Piel = ({ navigation }: PielProps) => {
  ...
  return (
    <View style={styles.generalContainer}>
      ...
      <HeaderSettingsReturnShadow navigation={navigation} title="Cuidado de la piel" />
      ...
      <ScrollView style={styles.scrollView} keyboardShouldPersistTaps="always">
        ...
        <View style={styles.containerMainImage}>
          <Image style={styles.mainImage} source={require('../../android/assets/img/categorias/cabello.png')} />
        </View>

        <View style={styles.contentMain}>

          <Text style={styles.descriptionTitle}>Cuidado de la piel</Text>

          <Text style={styles.descriptionText}>
            El cuidado capilar trasciende lo estético, convirtiéndose en un pilar fundamental de nuestra presentación personal. Un cabello bien cuidado no solo refleja vitalidad y salud, sino que también fortalece la confianza en uno mismo. Cada detalle atendido con esmero se convierte en un testimonio de dedicación hacia una imagen impecable.
          </Text>
